      ...
      <ReactMarkdown
        ...
        components={{
          ...
          p: (props) => {
            return (
              <p
                className="leading-relaxed text-neutral-800 dark:text-neutral-200 mb-4"
                {...props}
              />
            );
          },
          ...
          thead: (props) => (
            <thead className="bg-neutral-300 dark:bg-neutral-700" {...props} />
          ),
...
import { useSmoothText } from "@convex-dev/agent/react"; // already imported above
...
export const MemoizedMarkdown = memo(
  ({
    ...
    const blocks = useMemo(
      () => parseMarkdownIntoBlocks(visibleText),
      [visibleText]
    );
